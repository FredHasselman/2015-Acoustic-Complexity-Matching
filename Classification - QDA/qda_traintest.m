%% Note: Adapted by Fred Hasselman to return mean class memberhip 
%
...
function [AVperf, perform, confidence, mu0E, mu1E, C0E, C1E] = qda_traintest(featvec, labels, bootN, varargin)
